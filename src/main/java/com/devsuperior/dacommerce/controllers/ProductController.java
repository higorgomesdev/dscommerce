...
public class ProductController {
	...
	@GetMapping
	public ResponseEntity<Page<ProductMinDTO>> findAll(@RequestParam(name = "name", defaultValue = "") String name, Pageable pegeable) {
		return ResponseEntity.ok(service.findAll(name, pegeable));
	}
